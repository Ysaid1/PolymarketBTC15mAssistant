...
// ethers v5 uses utils.Interface, v6 uses Interface directly
const iface = ethers.utils ? new ethers.utils.Interface(AGGREGATOR_ABI) : new ethers.Interface(AGGREGATOR_ABI);
